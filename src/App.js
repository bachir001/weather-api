...
import clear from "C:/Users/coyboy/repos/Weather_API/weather-api/src/img/weather-icons/clear.svg"
...
class App extends Component {
  ...
  document.getElementById("app_main").style.backgroundColor = "#506063"; 
  document.getElementById("Items").style.backgroundColor = "#506063"; 
  ...
  document.getElementById("app_main").style.backgroundColor = "#c5d6d9"; 
  document.getElementById("Items").style.backgroundColor = "#c5d6d9"; 
  ...
  render() {
    return (
      <div className="app">
       ...
       <WeatherNow  description={this.state.description} TempMin={this.state.TempMin} TempMax={this.state.TempMax} humidity={this.state.humidity} pressure={this.state.pressure}/>
